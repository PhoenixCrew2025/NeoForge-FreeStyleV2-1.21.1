...
@Mod(FreeStyleV2.MOD_ID)
public class FreeStyleV2 {
    public static final String MOD_ID = "freestylev2";



    public FreeStyleV2(IEventBus modEventBus, ModContainer modContainer)
    {
