...
import net.phoenixcrew2025.FreeStyleV2.item.custom.ChiselItem;
...
public class ModItems {
    ...
    public static final DeferredItem<Item> AURELIA_S2_DISC = ITEMS.register("aurelia_s2_disc",
            () -> new Item(new Item.Properties().jukeboxPlayable(ModSounds.AURELIA_S2_KEY).stacksTo(1)));
    ...
    public static final DeferredItem<Item> RADISH = ITEMS.register("radish",
            () -> new Item(new Item.Properties().food(ModFoodProperties.RADISH)) {
                ...
                public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
                    tooltipComponents.add(Component.translatable("tooltip.freestylev2.radish.tooltip"));
    ...
    public static final DeferredItem<Item> KAUPEN_SMITHING_TEMPLATE = ITEMS.register("kaupen_armor_trim_smithing_template",
            () -> SmithingTemplateItem.createArmorTrimTemplate(ResourceLocation.fromNamespaceAndPath(FreeStyleV2.MOD_ID, "kaupen")));


    public static final DeferredItem<Item> QUEST_REEDEM_1 = ITEMS.register("quest_reedem_1",
            () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> QUEST_REEDEM_2 = ITEMS.register("quest_reedem_2",
            () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> QUEST_REEDEM_3 = ITEMS.register("quest_reedem_3",
            () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> QUEST_REEDEM_4 = ITEMS.register("quest_reedem_4",
            () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> QUEST_REEDEM_5 = ITEMS.register("quest_reedem_5",
            () -> new Item(new Item.Properties()));
    ...
    public static final DeferredItem<Item> NIGHTMAREV2_GYM_BADGE = ITEMS.register("nightmarev2_gym_badge", () -> new Item(new Item.Properties()) {
        public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
            tooltipComponents.add(Component.translatable("tooltip.freestylev2.nightmarev2_gym_badge.tooltip"));
            super.appendHoverText(stack, context, tooltipComponents, tooltipFlag);
        }
    });
